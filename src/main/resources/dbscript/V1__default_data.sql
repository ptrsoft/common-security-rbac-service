...
VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'default organization', 'PTRSOFT', 'ACTIVE');

-- insert in permission_category
INSERT INTO permission_category (id, created_at, created_by, updated_at, description, "name", status, "version", organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Environment', 'Environment', 'ACTIVE', 1, (select id from organization where name = 'PTRSOFT'));
INSERT INTO permission_category (id, created_at, created_by, updated_at, description, "name", status, "version", organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Product', 'Product', 'ACTIVE', 1, (select id from organization where name = 'PTRSOFT'));
INSERT INTO permission_category (id, created_at, created_by, updated_at, description, "name", status, "version", organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'SRE', 'SRE', 'ACTIVE', 1, (select id from organization where name = 'PTRSOFT'));
INSERT INTO permission_category (id, created_at, created_by, updated_at, description, "name", status, "version", organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'DevSecOps', 'DevSecOps', 'ACTIVE', 1, (select id from organization where name = 'PTRSOFT'));
---- insert in permission table
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Create Landing Zone', 'Create Landing Zone', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Edit Landing Zone', 'Edit Landing Zone', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Clone Landing Zone', 'Clone Landing Zone', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Migrate Landing Zone', 'Migrate Landing Zone', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Delete Landing Zone', 'Delete Landing Zone', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Replicate Landing Zone', 'Replicate Landing Zone', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Create Product Enclave', 'Create Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Edit Product Enclave', 'Edit Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Clone Product Enclave', 'Clone Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Migrate Product Enclave', 'Migrate Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Delete Product Enclave', 'Delete Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Replicate Product Enclave', 'Replicate Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Add Service Mesh in Product Enclave', 'Add Service Mesh in Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Edit Service Mesh in Product Enclave', 'Edit Service Mesh in Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Delete Service Mesh in Product Enclave', 'Delete Service Mesh in Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Add Api Gateway in Product Enclave', 'Add Api Gateway in Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Edit Api Gateway in Product Enclave', 'Edit Api Gateway in Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Delete Api Gateway in Product Enclave', 'Delete Api Gateway in Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Add firewall in Product Enclave', 'Add firewall in Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Edit firewall in Product Enclave', 'Edit firewall in Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Delete firewall in Product Enclave', 'Delete firewall in Product Enclave', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Create Container Cluster', 'Create Container Cluster', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Edit Container Cluster', 'Edit Container Cluster', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Clone Container Cluster', 'Clone Container Cluster', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Migrate Container Cluster', 'Migrate Container Cluster', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Delete Container Cluster', 'Delete Container Cluster', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Replicate Container Cluster', 'Replicate Container Cluster', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Create Product Environment', 'Create Product Environment', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Edit Product Environment', 'Edit Product Environment', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Clone Product Environment', 'Clone Product Environment', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Migrate Product Environment', 'Migrate Product Environment', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Delete Product Environment', 'Delete Product Environment', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Replicate Product Environment', 'Replicate Product Environment', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Add Service in Product Environment', 'Add Service in Product Environment', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Edit Service in Product Environment', 'Edit Service in Product Environment', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Delete Service in Product Environment', 'Delete Service in Product Environment', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Replicate Service in Product Environment', 'Replicate Service in Product Environment', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Enable SLA monitoring for Service', 'Enable SLA monitoring for Service', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Disable SLA monitoring for Service', 'Disable SLA monitoring for Service', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Enable Log for Cloud Element', 'Enable Log for Cloud Element', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Enable Trace for Cloud Element', 'Enable Trace for Cloud Element', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Enable complaince audits for Landing Zone', 'Enable complaince audits for Landing Zone', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Generate Service from Template', 'Generate Service from Template', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Perform code security audit for service', 'Perform code security audit for service', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Perform code scanning for sonar complaince', 'Perform code scanning for sonar complaince', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Perform bdd tests on service', 'Perform bdd tests on service', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."permission" (id, created_at, created_by, updated_at, description, "name", "version", status, organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Perform atp tests on service', 'Perform atp tests on service', 1, 'ACTIVE', (select id from organization where name = 'PTRSOFT'));
...
-- create PTRSOFT policy
INSERT INTO public."policy"(id, created_at, created_by, updated_at, updated_by, description, "name", status, "version", organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, NULL, 'All Access Policy', 'All Access', 'ACTIVE', 1, (select id from organization where name = 'PTRSOFT'));
INSERT INTO public."policy"(id, created_at, created_by, updated_at, updated_by, description, "name", status, "version", organization_id) VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, NULL, 'No Access Policy', 'No Access', 'ACTIVE', 1, (select id from organization where name = 'PTRSOFT'));
...
VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Administrator is the highest level of administrative authority within a system', false, true, 'Administrator', 1, (select id from organization where name = 'PTRSOFT'));
INSERT INTO roles (id, created_at, created_by, updated_at, description, grp, is_default, "name", "version", organization_id)
VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'A basic user', false, true, 'Basic User', 1, (select id from organization where name = 'PTRSOFT'));
INSERT INTO roles (id, created_at, created_by, updated_at, description, grp, is_default, "name", "version", organization_id)
VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'Super Admins is the highest level of administrative authority within a system', true, true, 'Super Admins', 1, (select id from organization where name = 'PTRSOFT'));
INSERT INTO roles (id, created_at, created_by, updated_at, description, grp, is_default, "name", "version", organization_id)
VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'A basic user role group', true, true, 'Default Users', 1, (select id from organization where name = 'PTRSOFT'));
...
VALUES((SELECT nextval('psql_seq')), current_timestamp, 'System', current_timestamp, 'System', true, 'BzqrSR6r4qnx3TURlr4M3w==', '$shiro1$SHA-256$500000$gmsw0Pw/9KjOYsKGI0seJQ==$BWCzd2tuiNT8kMfMVhQm2OJnICWqVvIioFU2VUnb+h4=', NULL, 'SUPER ADMIN', 'admin', (select id from organization where name = 'PTRSOFT'));
